...
class ProductData {
  static const List<Product> products = [
    ...
    Product(
      ...
      description: 'Fresh organic carrots, rich in vitamin A. Perfect for salads and cooking.',
      price: 50.00,
      unit: 'kg',
      category: 'Vegetables',
    ),
    Product(
      ...
      title: 'Green Beans',
      description: 'Fresh green beans, perfect for stir-fry and curries. Crisp and healthy.',
      price: 60.00,
      unit: 'kg',
      category: 'Vegetables',
    ),
    Product(
      ...
      title: 'Fresh Bananas',
      description: 'Sweet and ripe bananas, rich in potassium. Perfect for energy boost.',
      price: 40.00,
      unit: 'dozen',
      category: 'Fruits',
    ),
    Product(
      ...
      title: 'Orange Juice',
      description: 'Fresh squeezed orange juice, 100% natural with no added sugar.',
      price: 50.00,
      unit: 'liter',
      category: 'Beverages',
    ),
  ...
  static const List<Product> homeFoodProducts = [
    Product(
      id: '101',
      image: 'https://images.unsplash.com/photo-1546833999-b9f5816029bd?w=500&q=80',
      title: 'Dal Makhani',
      description: 'Rich and creamy Dal Makhani, slow-cooked to perfection with black lentils and kidney beans. Served with a dollop of butter and fresh cream.',
      price: 180.00,
      unit: 'plate',
    ...
    Product(
      ...
      description: 'Soft cottage cheese cubes cooked in a rich and creamy tomato-based gravy. A classic North Indian dish that pairs perfectly with naan or rice.',
      price: 220.00,
      unit: 'plate',
      category: 'North Indian',
    ),
    Product(
      ...
      description: 'Aromatic basmati rice cooked with tender chicken pieces and a blend of exotic spices. Served with raita and salan for a complete meal.',
      price: 250.00,
      unit: 'plate',
      category: 'Biryani',
    ),
    Product(
      ...
      title: 'Masala Dosa',
      description: 'Crispy fermented crepe made from rice batter and black lentils, stuffed with a spiced potato filling. Served with coconut chutney and sambar.',
      price: 90.00,
      unit: 'piece',
    ...
    Product(
      ...
      title: 'Samosa',
      description: 'Deep-fried pastry filled with a savory filling of spiced potatoes, onions, and peas. A popular Indian snack best enjoyed with mint chutney.',
      price: 20.00,
      unit: 'piece',
      category: 'Snacks',
    ),
    Product(
      id: '106',
      image: 'https://images.unsplash.com/photo-1567188040754-583522d069e5?w=500&q=80',
      title: 'Aloo Paratha',
      description: 'Whole wheat flatbread stuffed with a spiced potato filling. Cooked on a griddle with ghee and served with curd and pickle.',
      price: 60.00,
      unit: 'piece',
      category: 'Breakfast',
    ),
    Product(
      ...
      title: 'Gulab Jamun',
      description: 'Soft and spongy milk-solid balls soaked in rose-flavored sugar syrup. A classic Indian dessert that melts in your mouth.',
      price: 40.00,
      unit: '2 pcs',
      category: 'Dessert',
    ),
    Product(
      ...
      title: 'Veg Thali',
      description: 'A complete meal consisting of roti, rice, dal, two vegetable dishes, raita, salad, and a sweet. A wholesome and balanced diet.',
      price: 150.00,
      unit: 'plate',
      category: 'Meals',
    ),
