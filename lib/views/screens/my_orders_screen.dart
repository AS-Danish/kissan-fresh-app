                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              Material(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Icon(Icons.call_rounded, size: 20, color: Theme.of(context).primaryColor),
                                  ),
                                ),
                              ),
                            ],
                      ...
                      if (order.paymentId != null && order.paymentId!.isNotEmpty)
                        _buildDetailRow(context, 'Transaction ID', order.paymentId!),
                      
                      const SizedBox(height: 20),

                      // Section: Items
                      _buildSectionHeader(context, 'Items (${order.items.length})'),
                      const SizedBox(height: 12),
                      ...
                      const SizedBox(height: 12),
                      _buildSummaryRow(context, 'Subtotal', '₹${order.subtotal.toStringAsFixed(0)}'),
                      if (order.deliveryFee > 0)
                        _buildSummaryRow(context, 'Delivery Fee', '₹${order.deliveryFee.toStringAsFixed(0)}'),
                      if (order.deliveryFee == 0)
                        _buildSummaryRow(context, 'Delivery Fee', 'FREE', isGreen: true),
                      if (order.discount > 0)
                        _buildSummaryRow(context, 'Product Discount', '-₹${order.discount.toStringAsFixed(0)}', isGreen: true),
                      if (order.couponDiscount > 0)
                        _buildSummaryRow(context, 'Coupon Discount', '-₹${order.couponDiscount.toStringAsFixed(0)}', isGreen: true),
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.montserrat(
              ...
              color: isGreen ? const Color(0xFF10B981) : Theme.of(context).colorScheme.onSurface,
            ),
          ),
        ],
      ),
