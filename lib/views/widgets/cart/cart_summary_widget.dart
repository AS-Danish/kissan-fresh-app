...
class CartSummaryWidget extends StatelessWidget {
  ...
  Widget _buildPriceSummary(BuildContext context, CartController controller) {
    return Obx(() => Column(
      children: [
        _buildPriceRow(context, controller, 'Subtotal', '₹${controller.subtotal.toStringAsFixed(0)}'),
  ...
  Widget _buildPriceRow(BuildContext context, CartController controller, String label, String amount,
          ...
          children: [
            ...
            Column(
              children: [
                ...
                _buildPriceRow(context, controller, 'Delivery Fee', '₹${controller.deliveryFee.toStringAsFixed(0)}', isDelivery: controller.deliveryFee == 0),
                if (controller.discount > 0) ...[
                   const SizedBox(height: 6),
                   _buildPriceRow(
                     context, 
