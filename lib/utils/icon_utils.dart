...
class IconUtils {
  ...
  static IconData getCategoryIcon(String name) {
    ...
    if (n.contains('poultry') || n.contains('meat') || n.contains('chicken')) {
      return Icons.set_meal_rounded;
    }
    if (n.contains('pantry') || n.contains('spice')) {
      return Icons.whatshot_rounded;
    }
    if (n.contains('grain')) {
      return Icons.grain_rounded;
    }
    if (n.contains('beverage') || n.contains('juice')) {
    ...
    if (n.contains('beauty') || n.contains('spa')) {
      return Icons.spa_rounded;
    }
    if (n.contains('fashion') || n.contains('cloth')) {
      return Icons.checkroom_rounded;
    }
    if (n.contains('footwear') || n.contains('shoe')) {
      return Icons.storefront_rounded;
    }
    if (n.contains('home') || n.contains('chair')) {
      return Icons.chair_rounded;
    }
    if (n.contains('kitchen')) {
      return Icons.kitchen_rounded;
    }
    if (n.contains('fitness') || n.contains('gym')) {
    ...
    if (n.contains('pharmacy') || n.contains('med')) {
    ...
    if (n.contains('curry') || n.contains('paneer')) {
      return Icons.soup_kitchen_rounded;
    }
    if (n.contains('south indian') || n.contains('dosa')) {
      return Icons.breakfast_dining_rounded;
    }
    if (n.contains('tandoor') || n.contains('starter')) {
      return Icons.kebab_dining_rounded;
    }
    if (n.contains('sweet') || n.contains('halwa') || n.contains('jamun')) {
      return Icons.icecream_rounded;
    }
    if (n.contains('snack') || n.contains('samosa') || n.contains('pickle')) {
      return Icons.cookie_rounded;
    }
    if (n.contains('bakery')) {
      return Icons.bakery_dining_rounded;
    }
    if (n.contains('tiffin')) {
